-- =========================================================================
-- MIGRATION 031: Report functions without is_org_member() guard.
-- Security is handled by RLS on journal_lines, journal_entries and
-- chart_of_accounts. The functions themselves just query by org id.
-- This also fixes the SQL Editor superuser context issue.
-- =========================================================================
